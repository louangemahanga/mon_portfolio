...
SECRET_KEY = 'django-insecure-5r5@=m0%9o*ek)thufn$-5eg*-03x1aw@d#l+l1n1_g_9+ed=l'
...
# nom = port2026, email portfolio@gmal.com password = port2003


# Configuration Email (Exemple pour Gmail)
# EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'# config/settings.py (à la fin du fichier)

# SOLUTION DE SECOURS : Affiche l'email dans le terminal
